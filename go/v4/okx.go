...
func (this *OkxCore) FetchMarkets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes167012 := (<-this.LoadTimeDifference())
...
func (this *OkxCore) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes248119 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
...
func (this *OkxCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes259519 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
...
func (this *OkxCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes270319 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
			PanicOnError(retRes270319)
			ch <- retRes270319
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *OkxCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes302915 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes305215 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes438719 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, maxLimit))
			PanicOnError(retRes438719)
			ch <- retRes438719
			return nil
		}
		var request interface{} = map[string]interface{}{}
...
func (this *OkxCore) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes47348 := (<-this.LoadMarkets())
		PanicOnError(retRes47348)
		var maxLimit interface{} = 100
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes473919 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, maxLimit))
			PanicOnError(retRes473919)
			ch <- retRes473919
			return nil
		}
		var request interface{} = map[string]interface{}{}
...
func (this *OkxCore) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes491819 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *OkxCore) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes499315 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes499315)
		ch <- retRes499315
		return nil
...
func (this *OkxCore) FetchLedger(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes50138 := (<-this.LoadMarkets())
		PanicOnError(retRes50138)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes501719 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
			PanicOnError(retRes501719)
			ch <- retRes501719
			return nil
		}
...
func (this *OkxCore) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes53148 := (<-this.LoadMarkets())
		PanicOnError(retRes53148)
...
func (this *OkxCore) FetchDeposits(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes546319 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *OkxCore) FetchWithdrawals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes557119 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func (this *OkxCore) FetchPositionsForSymbol(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes606815 := (<-this.FetchPositions([]interface{}{symbol}, params))
...
func (this *OkxCore) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes663015 := (<-this.FetchFundingRate(symbol, params))
...
func (this *OkxCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes68958 := (<-this.LoadMarkets())
		PanicOnError(retRes68958)
		var market interface{} = this.Market(symbol)
		var marginMode interface{} = nil
...
func (this *OkxCore) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes70978 := (<-this.LoadMarkets())
		PanicOnError(retRes70978)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"ccy": GetValue(currency, "id"),
		}
...
func (this *OkxCore) FetchBorrowRateHistories(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes71878 := (<-this.LoadMarkets())
		PanicOnError(retRes71878)
		var request interface{} = map[string]interface{}{}
		if IsTrue(!IsEqual(since, nil)) {
...
func (this *OkxCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes738415 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *OkxCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes739815 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *OkxCore) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes75978 := (<-this.LoadMarkets())
		PanicOnError(retRes75978)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"ccy":  GetValue(currency, "id"),
			"amt":  this.CurrencyToPrecision(code, amount),
...
func (this *OkxCore) FetchOpenInterests(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes77508 := (<-this.LoadMarkets())
		PanicOnError(retRes77508)
...
func (this *OkxCore) FetchSettlementHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes80758 := (<-this.LoadMarkets())
		PanicOnError(retRes80758)
		var market interface{} = this.Market(symbol)
		var typeVar interface{} = nil
...
func (this *OkxCore) FetchGreeks(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes82138 := (<-this.LoadMarkets())
		PanicOnError(retRes82138)
		var market interface{} = this.Market(symbol)
...
func (this *OkxCore) FetchOptionChain(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes85168 := (<-this.LoadMarkets())
		PanicOnError(retRes85168)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
...
func (this *OkxCore) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes86648 := (<-this.LoadMarkets())
		PanicOnError(retRes86648)
		var request interface{} = map[string]interface{}{
			"quoteId":  id,
			"baseCcy":  fromCode,
			"quoteCcy": toCode,
...
func (this *OkxCore) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes87168 := (<-this.LoadMarkets())
		PanicOnError(retRes87168)
		var request interface{} = map[string]interface{}{
			"clTReqId": id,
		}
...
func (this *OkxCore) FetchMarginAdjustmentHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes89958 := (<-this.LoadMarkets())
		PanicOnError(retRes89958)
