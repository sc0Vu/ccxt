            ...
            'api': {
                ...
                'public': {
                    ...
                    'get': {
                        ...
                        'time': 0.2,
                        'depth': {
                            'cost': 1, // Weight(IP): 5 => cost = 0.2 * 5 = 1
                            'byLimit': [
                                [ 100, 1 ], // Weight(IP): 5 => cost = 0.2 * 5 = 1
                                [ 500, 5 ], // Weight(IP): 25 => cost = 0.2 * 25 = 5
                                [ 1000, 10 ], // Weight(IP): 50 => cost = 0.2 * 50 = 10
                                [ 5000, 50 ], // Weight(IP): 250 => cost = 0.2 * 250 = 50
                            ],
                        },
