...
func (this *MexcCore) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes233119 := (<-this.CreateSpotOrder(market, typeVar, side, amount, price, marginMode, query))
			PanicOnError(retRes233119)
			ch <- retRes233119
			return nil
		} else {

			retRes233319 := (<-this.CreateSwapOrder(market, typeVar, side, amount, price, marginMode, query))
...
func (this *MexcCore) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes311119 := (<-this.FetchOrdersByState(2, symbol, since, limit, params))
...
func (this *MexcCore) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes312915 := (<-this.FetchOrdersByState(3, symbol, since, limit, params))
...
func (this *MexcCore) FetchCanceledOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes314615 := (<-this.FetchOrdersByState(4, symbol, since, limit, params))
...
func (this *MexcCore) FetchOrdersByState(state interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes316119 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *MexcCore) FetchAccountHelper(typeVar interface{}, params interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(typeVar, "spot")) {
			...
			retRes370419 := (<-this.SpotPrivateGetAccount(params))
...
func (this *MexcCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes429215 := (<-this.ModifyMarginHelper(symbol, amount, "SUB", params))
		PanicOnError(retRes429215)
		ch <- retRes429215
		return nil
...
func (this *MexcCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes430615 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
		PanicOnError(retRes430615)
		ch <- retRes430615
		return nil
...
func (this *MexcCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes433915 := (<-this.ContractPrivatePostPositionChangeLeverage(this.Extend(request, params)))
		PanicOnError(retRes433915)
		ch <- retRes433915
		return nil
...
func (this *MexcCore) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes448315 := (<-this.FetchFundingRate(symbol, params))
...
func (this *MexcCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes61048 := (<-this.LoadMarkets())
		PanicOnError(retRes61048)
		var market interface{} = this.Market(symbol)
		if IsTrue(GetValue(market, "spot")) {
